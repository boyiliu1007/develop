...
<template>
  <div class="flex flex-col pt-24 ease-in-out duration-1000">
    <!--用 v-for 可以迭代-->
    <h1 class="text-3xl article-title self-center animate__animated animate__fadeInLeft">
      所有文章
    </h1>
    <!-- <hr/> -->
    <!-- 下面的 div 加 self-center 置中-->
    <div
      v-for="POST in posts"
      v-bind:key="POST.POST_ID"
      class="group self-center animate__animated animate__fadeInLeft"
    >
        ...
        <label for="collapsible" class="lbl-toggle text-center">
          <div class="card mb-3">
            <div class="card-body">
              ...
              <div class="control">
                <p class="btn">
                  <a :href="frontEndUrl + '/post/' + POST.POST_ID">
                    View Comments
                  </a>
                </p>
              </div>
